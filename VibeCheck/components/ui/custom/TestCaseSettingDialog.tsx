    ...
    <Dialog>
      ...
      <DialogContent>
        ...
        <div>
            ...
            <div className='mt-5'>
                <label className='text-xs font-semibold text-gray-500'>DESCRIPTION/ACTION</label>
                <Textarea value={formTestCase?.description} 
                          onChange={(event) => handleInputChange('description', event?.target?.value)} 
                          placeholder='Description' className='mt-1' />
            </div>
            <div className='mt-5'>
                <label className='text-xs font-semibold text-gray-500'>TARGET ROUTE/PATH</label>
            ...
            <div className='mt-5'>
                <label className='text-xs font-semibold text-gray-500'>EXPECTED RESULT</label>
